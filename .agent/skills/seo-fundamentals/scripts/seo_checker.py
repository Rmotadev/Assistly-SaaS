...
def check_page(file_path: Path) -> dict:
    ...
    # Detect if this is a layout/template file or has metadata
    is_layout = 'Head>' in content or '<head' in content.lower() or 'metadata =' in content or 'metadata:' in content
    ...
    # 2. Meta description
    has_description = 'name="description"' in content.lower() or 'description:' in content or 'name=\'description\'' in content.lower()
